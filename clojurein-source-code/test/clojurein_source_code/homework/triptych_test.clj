...
(deftest t-find-all-triptychs
  (testing "test find-all-triptychs"
...
(deftest t-cap-is-subset-3
  (testing "cap is subset 3"
    (test-cap-subset 3)))

(deftest t-cap-is-subset-5
  (testing "cap is subset 5"
    (test-cap-subset 5)))

(deftest t-cap-is-subset-8
  (testing "cap is subset 8"
    (test-cap-subset 8)))
...
(deftest t-find-cap-3-14
  (map test-cap (range 3 15)))
