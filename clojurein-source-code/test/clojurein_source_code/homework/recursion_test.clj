...
(deftest t-product-doubles
  (testing "HW product doubles simple recursion a"
...
(deftest t-product-doubles-loop-recur
  (testing "HW product doubles loop/recur"
...
(deftest t-product-doubles-reduce
  (testing "HW product doubles reduce"
